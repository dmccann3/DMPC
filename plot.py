...
def plot(time, ref_states_and_controls, final_states, final_controls):
    ...
    # ax_posX.plot(time[:-1], ref_states_and_controls['xref'], label='x_ref')
    ...
    ax_posX.legend()
    ax_posX.grid()
    # ax_posY.plot(time[:-1], ref_states_and_controls['yref'], label='y_ref')
    ...
    ax_posY.legend()
    ax_posY.grid()
    # ax_posZ.plot(time[:-1], ref_states_and_controls['zref'], label='z_ref')
    ...
    # ax_oriX.plot(time[:-1], ref_states_and_controls['phiref'], label='phi_ref')
    ...
    ax_oriX.legend()
    ax_oriX.grid()
    # ax_oriY.plot(time[:-1], ref_states_and_controls['thetaref'], label='theta_ref')
    ...
    ax_oriY.legend()
    ax_oriY.grid()
    # ax_oriZ.plot(time[:-1], ref_states_and_controls['psiref'], label='psi_ref')
    ...
    # ax_velX.plot(time[:-1], ref_states_and_controls['vxref'], label='vx_ref')
    ax_velX.plot(time, final_states[:, 6], label='vx')
   
    ax_velX.set_ylabel('Velocity (m/s)')
    ax_velX.legend()
    ax_velX.grid()
    # ax_velY.plot(time[:-1], ref_states_and_controls['vyref'], label='vy_ref')
    ax_velY.plot(time, final_states[:, 7], label='vy')

    ax_velY.set_ylabel('Velocity (m/s)')
    ax_velY.legend()
    ax_velY.grid()
    # ax_velZ.plot(time[:-1], ref_states_and_controls['vzref'], label='vz_ref')
    ...
    # ax_angX.plot(time[:-1], ref_states_and_controls['wxref'], label='wx_ref')
    ax_angX.plot(time, final_states[:,9], label='wx')

    ax_angX.set_ylabel('Velocity (rad/s)')
    ax_angX.legend()
    ax_angX.grid()
    # ax_angY.plot(time[:-1], ref_states_and_controls['wyref'], label='wy_ref')
    ax_angY.plot(time, final_states[:,10], label='wy')

    ax_angY.set_ylabel('Velocity (rad/s)')
    ax_angY.legend()
    ax_angY.grid()
    # ax_angZ.plot(time[:-1], ref_states_and_controls['wzref'], label='wz_ref')
    ...
    # ax_rpm.plot(time[:-1], ref_states_and_controls['w1ref'], label='w1', color='black')
    # ax_rpm.plot(time[:-1], ref_states_and_controls['w2ref'], label='w2', color='black')
    # ax_rpm.plot(time[:-1], ref_states_and_controls['w3ref'], label='w3', color='black')
    # ax_rpm.plot(time[:-1], ref_states_and_controls['w4ref'], label='w4', color='black')
